  ...
  const handleSaveTransaction = async (data: any) => {
    ...
    if (editingTransaction?.id) {
      ...
      try {
        ...
        alert('Erro ao atualizar lançamento no banco de dados.');
      }
      return;
    }
            ...
            <div className="flex items-center gap-3 lg:gap-4">
              <div className="flex items-center gap-2">
                <div className="text-right">
                  <p className="text-[11px] font-bold text-white uppercase tracking-wider hidden sm:block">Saldo atual</p>
                  <p className={`text-base sm:text-xl font-bold ${stats.balance >= 0 ? 'text-blue-400' : 'text-red-400'}`}>
